use std::{collections::BTreeMap, error::Error as StdError, marker::PhantomData, sync::Arc};

use core::result::Result as StdResult;
use futures::future::BoxFuture;
use matrix_sdk::{
    event_handler::SyncEvent,
    ruma::{OwnedRoomId, OwnedUserId, events::AnySyncTimelineEvent, serde::Raw},
};
    ...
    Ev: SyncEvent,
{
    fn get_type(&self) -> Result<&'static str> {
        Ev::TYPE.ok_or(Error::EventType(
            "Error adding event handler, invalid event type".to_string(),
        ))
    }
}
